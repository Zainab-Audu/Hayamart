...
const HomeHeroSection = () => {
  return (
    <React.Fragment>
      <div className="bg-gradient-to-r from-red-950 to-yellow-900  via-[#ffffff] to-[#fcd2d2]">
        <section className=" max-w-6xl mx-auto flex flex-col-reverse justify-center items-center gap-20 py-16 lg:flex-row ">
          <div className="flex flex-col gap-6 items-start px-4">
            ...
            <Link to="/order" className="flex items-center gap-0">
              <p className="bg-[#751614]  text-[#FFF] font-semibold px-5 py-2 ">
                Discover{" "}
              </p>
              <span className="bg-[#751614] text-[#FFF] opacity-80 py-2 px-2 hover:opacity-100 duration-300">
